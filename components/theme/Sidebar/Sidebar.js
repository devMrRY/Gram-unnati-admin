...
// core components
import AdminNavbarLinks from "components/theme/Navbars/AdminNavbarLinks.js";
            ...
            <Link href={prop.layout + prop.path} passHref key={key}>
              <a className={classes.item}>
                <ListItem button className={classes.itemLink + listItemClasses}>
                  ...
                  <Box className={classes.navTextContainer}>
                    <ListItemText
                      primary={`${prop.name}`}
                      className={classNames(classes.itemText, whiteFontClasses, {
                        [classes.itemTextRTL]: props.rtlActive,
                      ...
                      disableTypography={true}
                    />
                    {prop.child && <ArrowRightIcon
                      className={classNames(classes.itemIcon, whiteFontClasses, {
                        [classes.rotateIcon]: activeRoute(prop.layout + prop.path),
                      })}
                    />}
                  </Box>
                </ListItem>
